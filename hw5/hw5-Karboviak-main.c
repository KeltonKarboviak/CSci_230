/*
 * File:   hw5-Karboviak-main.c
 * Author: Kelton Karboviak
 */

#define TEST1

#include "./hw5-Karboviak-main.h"
#include "./hw5-Karboviak-find.h"
#include "./hw5-Karboviak-load.h"
#include "./hw5-Karboviak-forward.h"
 ...
 ************************************************************\n\n";
	...
	if (argc != 5 && argc != 2) {
		...
		printf("\n");
 		printf(" ************************************************************\n");
 		printf(" * HW5 Help Menu.                                           *\n");
 		printf(" *                                                          *\n");
		printf(" * HW5 will fail to start if no command line arguments are  *\n");
		printf(" * provided. To get this help menu start AADS as follows:   *\n");
		printf(" * ./HW5 ?                                                  *\n");
		printf(" *                                                          *\n");
		printf(" * Required command line arguments include:                 *\n");
		printf(" * ./HW5 DNA_file FASTA_file Forward_count Reverse_count    *\n");
 		printf(" *                                                          *\n");
	 	printf(" ************************************************************\n");
	 	printf("\n");
		exit (0);
